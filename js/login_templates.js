        ...
        <div class="register-card-container">
            <div class="register-card">
                ...
                <form class="register-form" onsubmit="signUp(); return false;">
                    <input type="hidden" name="csrfmiddlewaretoken" id="csrf-token" value="">
                    <div id="register-inputs">
                        <div class="register-input-container">
                            <div class="register-input-wrapper">
                                <input class="register-name-input" type="text" name="first_name" id="name-register" placeholder="Name" required
                        ...
                        <div class="register-input-container">
                            <div class="register-input-wrapper" id="pw-wrapper">
                                <input class="register-pw-input" type="password" name="password" id="password-register" placeholder="Password"
                        ...
                        <div class="register-input-container">
                            <div class="register-input-wrapper" id="pw-wrapper">
                                <input class="register-pw-input" type="password" name="password_confirm" id="password-confirm" placeholder="Confirm Password"
